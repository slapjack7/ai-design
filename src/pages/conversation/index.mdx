...
By understanding how we communicate with each other we can begin to replicate this with a machine. For our intents and purposes, conversation is the meaningful exchange of ideas and information between two or more individuals. The requisite parts of a conversation are topics, exchanges, and utterances.
...
## Conclusion
We’re still figuring out what a human/AI relationship looks like, but if it looks anything like our current relationships conversations are essential. It takes two to grow a relationship, and it takes understanding the inherent strengths of humans and machines to design for a relationship between the two.  It requires us to understand how and why we forge relationships with people and why we’d be willing to invest in a relationship with something new and foreign to many people.

Designing conversations requires us to know ourselves better than ever before.
